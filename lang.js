...
(function () {
  ...
  const T = {
    en: {
      ...
      'p1-sol2': 'Because if one bar is never enough, one ride shouldn&rsquo;t be either.',
    ...
    da: {
      ...
      'p1-sol2': 'For hvis &eacute;t stykke aldrig er nok, burde &eacute;n tur heller ikke v&aelig;re det.',
